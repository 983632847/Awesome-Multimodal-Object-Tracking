...
'''
cd /mnt/sdb/zhangchunhui/SAM2/VL-SAM2/training/
conda activate SAM2 
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-c",
        "--config",
        # default="configs/sam2b_YTVOS_finetune.yaml",
        default="configs/sam2l_YTVOS_finetune.yaml",
        type=str,
    ...
    parser.add_argument(
        "--num-gpus", type=int, default=4, help="number of GPUS per node"
    )
