...
class ExperimentNAT2021L(object):
    ...
    def __init__(self, root_dir, att_name, sce_name, return_meta=True, result_dir='results', report_dir='reports', report_scenario_dir='reports_scenario'):
        super(ExperimentNAT2021L, self).__init__()
        self.return_meta = return_meta
        self.dataset = NAT2021L(root_dir, self.return_meta)   ##########
        ...
        self.result_dir = os.path.join(result_dir, 'Baseline_Results', 'NAT2021L')
        # self.result_dir = os.path.join(result_dir, 'Baseline_Results', 'FrameRate_Drops')

        # report root
        self.report_dir = os.path.join(report_dir, 'NAT2021L')
        ...
        self.att_dict = {
            ...
            'Background_clutter': 1,
            'Camera_motion': 2,
            'Fast_motion': 3,
            'Full_occlusion': 4,
            'Illumilation_variation': 5,
            'Low_ambient_intensity': 6,
            'Out_of_view': 7,
            'Partial_occlusion': 8,
            'Scale_variation': 9,
            'Similar_object': 10,
