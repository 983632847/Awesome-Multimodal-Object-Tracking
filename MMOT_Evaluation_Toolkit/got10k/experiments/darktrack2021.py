...
from ..datasets import DarkTrack2021
...
class ExperimentDarkTrack2021(object):
    ...
    def __init__(self, root_dir, att_name, sce_name, return_meta=True, result_dir='results', report_dir='reports', report_scenario_dir='reports_scenario'):
        super(ExperimentDarkTrack2021, self).__init__()
        self.return_meta = return_meta
        self.dataset = DarkTrack2021(root_dir, self.return_meta)   ##########
        ...
        self.result_dir = os.path.join(result_dir, 'Baseline_Results', 'DarkTrack2021')
        # self.result_dir = os.path.join(result_dir, 'Baseline_Results', 'FrameRate_Drops')

        # report root
        self.report_dir = os.path.join(report_dir, 'DarkTrack2021')
        ...
        # 10+14+15+16+3=58
        self.att_dict = {
            'Viewpoint_change':0, 'Fast_motion':1, 'Low_resolution':2, 'Occlusion':3,'Illumilation_variation':4
        }
    ...
    def plot_curves(self, tracker_names, att_name):
        ...
        if att_name == "All":
            title_name_suffix = " on DarkTrack2021"
        else:
