...
if __name__ == '__main__':
    ...
    for i in range(len(Trackers_Name)):
        ...
        video_paths = glob.glob(os.path.join('/mnt/Data/Tracking_Datasets_2/Night_UAV_Tracking/Datasets/NUT318/Test', '*'))
        video_num = len(video_paths)

        # Results: Test
        output_dir = os.path.join('results/Baseline_Results/NUT318', Tracker_Name)
